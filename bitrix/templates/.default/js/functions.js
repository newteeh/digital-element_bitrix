	...
	$(".fl_showchild").on('click', 	function() {
	...
	$(".vc_showchild").on('click', 	function() {
		ParentElement = $(this).parent("li");
		FindElement = ParentElement.find("ul");
		FindElement2 = ParentElement.find("ul li");
	...
	$(".vc_showchild-2").on('click', 	function() {
		ParentElement = $(this).parent("li");
		FindElement = ParentElement.find("ul");
		FindElement2 = ParentElement.find("ul li");
